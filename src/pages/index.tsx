  ...
  return (
    <Layout>
      <div className="p-4 max-w-[720px] mx-auto bg-white rounded shadow">
        <h1 className="font-bold text-4xl text-center">Frontend Engineer Assessment</h1>
        <p className="mt-6">
          Welcome to our frontend engineer assessment! This test is designed to evaluate your frontend development
          skills and related knowledge.
        </p>
        <p className="mt-4">
          Please read each question carefully and imagine them as typical work tasks. Respond in the same manner you
          would during your regular work.
        </p>
        <p className="mt-4">
        ...
        <ul className="list-decimal pl-6">
          <li className="mt-1">
            <strong>NEVER</strong> change anything in the directories named in the pattern
          ...
          <li className="mt-1">
            <p>
              ...
              <strong className="mx-1">23:59 on the 5th day after receiving the questions,</strong>
              and cease answering (pushing commits). For example: if you receive the questions on Mar 1st, you should
              submit the answer by 23:59 on Mar 5th.
            </p>
          </li>
        </ul>
        ...
        <div className="mt-6 border-t pt-6">
          ...
          <p className="mt-1">
            For this task, your objective is to refactor the current page following your coding conventions and best
            practices. Look for opportunities to enhance code structure, eliminate redundancy, clarify variable names,
            and simplify complex logic.
          </p>
        </div>
        <div className="mt-6 border-t pt-6">
          ...
          <p className="mt-4">
            ...
            endpoint to fetch the maze map array and display all the maps along with their respective start buttons on
            the screen. When the user clicks the start button, the mouse on that map will begin to solve the maze using
            Depth-First Search (DFS), with each step taking 100 ms.
          </p>
          <p className="mt-4">
            Meanwhile, the start button will disappear, replaced by a reset button. Clicking the reset button will stop
            the mouse's movement, reset the map to its initial state, and the reset button will be replaced by the start
            button again.
          </p>
          <p className="mt-4">
            <a
          ...
          <ul className="list-decimal pl-6">
            ...
            <li className="mt-1">
              ...
              simulates an endpoint on another server, so you need to use axios to fetch the data.
            </li>
          </ul>
        </div>
        <div className="mt-6 border-t pt-6">
          ...
          <ul className="list-decimal pl-6">
            <li className="mt-1">
              A header displaying
              <strong className="mx-1">'Jedi Software'</strong> that collapses when scrolling up and reappears when
              scrolling stops.
            </li>
            <li className="mt-1">
